            ...
            while self.running:
                ...
                if alerts:
                    for alert in alerts:
                        ...
                        try:
                            # Envoi notification de manière synchrone dans un thread séparé
                            import threading
                            def send_notification():
                                try:
                                    # Version synchrone des notifications
                                    self.notification_service.send_notification_sync(alert, self.patient)
                            ...
                            logger.error(f"❌ Erreur lancement notification: {e}")
