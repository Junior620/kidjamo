...
print("🚀 JOB SILVER-TO-GOLD CORRIGÉ POUR MPU CHRISTIAN")
...
try:
    ...
    if df.count() > 0:
        # Agrégations et métriques business pour Gold
        ...
        if gold_df.count() > 0:
            ...
            print("⚠️ Aucune donnée de haute qualité pour Gold")
    else:
